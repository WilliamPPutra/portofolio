...
export default function DemoBadge() {
    ...
    useEffect(() => {
        const onBlocked = () => {
            setToast('Aksi simpan dan hapus dinonaktifkan di demo.');
                    ...
                    <div className="bg-gray-900 text-white rounded-2xl shadow-2xl px-4 py-3 max-w-sm ring-1 ring-gray-700">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-[11px] leading-relaxed">
                                <p className="font-semibold text-xs mb-1">Data Simulasi · Privasi Dilindungi</p>
                                <p className="text-gray-300">
                                    Ini demo statis dari portal operasional asli. Seluruh nama lembaga, nomor telepon,
                                    angka penjualan, dan stok di halaman ini dibuat khusus untuk peragaan. Tidak ada data
                                    pelanggan atau data bisnis nyata yang ditampilkan, dan tidak ada koneksi ke server produksi.
                                </p>
                            </div>
