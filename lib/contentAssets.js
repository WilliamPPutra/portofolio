...
export const reelAccount = {
  ...
  collab: 'kafanku_official',
  audio: 'Original audio',
  profileUrl: 'https://instagram.com/pusatkainkafan',
};
...
export const influencers = {
  ...
  items: [
    { kind: 'video', slug: 'influencer-1', name: 'abuaisyafiah', views: '30K', viewsLabel: { en: '30K views', id: '30rb views' } },
    { kind: 'video', slug: 'influencer-2', name: 'auraimaa', views: '10.2M', viewsLabel: { en: '10.2M views', id: '10,2 jt views' } },
    { kind: 'video', slug: 'influencer-3', name: 'kakakmartabak', views: '16M', viewsLabel: { en: '16M views', id: '16 jt views' } },
  ],
};
