  ...
  cards: [
    {
      ...
      tag: {
        en: 'From the retail floor to Brand Lead — a deliberate climb through operations, data, and leadership.',
        id: 'Dari lantai ritel hingga Brand Lead — pendakian yang disengaja melewati operasional, data, dan kepemimpinan.',
      },
    },
    {
      href: '/portfolio',
...
// ── ABOUT ────────────────────────────────────────────────────────────────────
export const about = {
  eyebrow: { en: 'Brand Lead · Business Strategist', id: 'Brand Lead · Ahli Strategi Bisnis' },
  name: { en: 'William Pradana Putra', id: 'William Pradana Putra' },
  headline: {
    en: ['Bridging creative philosophy,', 'system architecture,', '& sustainable net profit.'],
    id: ['Menjembatani filosofi kreatif,', 'arsitektur sistem,', '& laba bersih berkelanjutan.'],
  },
  sub: {
    en: 'A deliberate climb — from the retail floor to macro-level brand leadership. I build business ecosystems that are creative, systemized, and profitable by design.',
    id: 'Sebuah pendakian yang disengaja — dari lantai ritel hingga kepemimpinan brand tingkat makro. Saya membangun ekosistem bisnis yang kreatif, tersistem, dan menguntungkan secara desain.',
  },
...
export const footer = {
  ...
  sub: {
    en: 'Open to brand leadership, strategy, and systems work.',
    id: 'Terbuka untuk kepemimpinan brand, strategi, dan pekerjaan sistem.',
  },
