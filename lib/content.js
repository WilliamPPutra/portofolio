...
export const projects = {
  ...
  os: {
    ...
    aiNote: {
      ...
      title: {
        en: 'I am not a programmer. I use AI to build what my team needs.',
        id: 'Saya bukan programmer. Saya memanfaatkan AI untuk membangun yang tim saya butuhkan.',
      },
      body: {
        en: 'My job is marketing, not engineering. But the team kept losing hours to manual work: recording orders by hand, creating shipping labels one by one, recalculating COGS and margin in spreadsheets. So I used AI to build the system myself and digitize that whole flow. Orders, shipping labels, COGS and margin calculation, and reporting now run in one place. I did not learn to code to do this. I described the problem clearly, let AI write the implementation, then tested it against how the team actually works.',
        id: 'Pekerjaan saya marketing, bukan engineering. Tapi tim terus kehilangan waktu untuk kerja manual: mencatat pesanan satu per satu, membuat resi manual, menghitung ulang HPP dan margin di spreadsheet. Jadi saya memanfaatkan AI untuk membangun sistemnya sendiri dan mendigitalisasi seluruh alur itu. Pesanan, pembuatan resi, perhitungan HPP dan margin, sampai pelaporan kini berjalan di satu tempat. Saya tidak belajar ngoding untuk ini. Saya merumuskan masalahnya dengan jelas, membiarkan AI menulis implementasinya, lalu mengujinya sesuai cara kerja tim sehari-hari.',
      },
      points: [
        {
        ...
        {
          t: { en: 'Built with AI, judged by the team', id: 'Dibangun dengan AI, dinilai oleh tim' },
          d: {
            en: 'AI wrote the code. The team decided whether it actually made their day easier.',
            id: 'AI yang menulis kodenya. Tim yang menentukan apakah ini benar-benar memudahkan kerja mereka.',
          },
        },
      ],
    },
  ...
  leads: [
    {
      ...
      href: '/games/amanah-terakhir/index.html',
