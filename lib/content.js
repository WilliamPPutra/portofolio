...
export const projects = {
  ...
  store: {
    ...
    demoCta: { en: 'Open the store demo', id: 'Buka demo tokonya' },
    cta: { en: 'Visit the live store', id: 'Kunjungi toko aslinya' },
    note: {
      en: 'The demo is a self-hosted copy, so it keeps working even if the live domain ever lapses. Browsing and checkout are real; ordering is switched off.',
      id: 'Demo-nya salinan yang saya simpan sendiri, jadi tetap hidup meski domain aslinya suatu saat tidak diperpanjang. Menjelajah dan checkout berjalan nyata; pemesanannya dimatikan.',
    },
    shots: [
      {
        img: 'store-home.webp',
