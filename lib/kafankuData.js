...
export const growth = {
  ...
  meta: {
    ...
    // Reporting period is Jan to Jun 2026. Every figure below is derived from
    // those six months only, so the chart and the totals stay consistent.
    roas: {
      blended: '4,37',
      bep: '2,52',           // break-even ROAS implied by the gross margin
      bepNum: 2.52,
      margin: '39,6%',       // gross margin on the channel
      headroom: '1,73x',     // how far above break-even the channel ran
      contribution: '16,7%', // gross profit after ad spend, as a share of channel revenue
      months: '6',
      lowest: '3,44',
      period: { en: 'Jan to Jun 2026', id: 'Jan hingga Jun 2026' },
    ...
    // The moments worth explaining rather than glossing over
    notes: {
      scale: {
        month: 'April',
        spendMult: '≈3x',
